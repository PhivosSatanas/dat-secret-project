...
${OBJECTDIR}/src/ExprDblList.o: src/ExprDblList.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ExprDblList.o src/ExprDblList.c
...
${OBJECTDIR}/src/IntStack.o: src/IntStack.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IntStack.o src/IntStack.c

${OBJECTDIR}/src/SymbolStack.o: src/SymbolStack.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SymbolStack.o src/SymbolStack.c

${OBJECTDIR}/src/SymbolTable.o: src/SymbolTable.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SymbolTable.o src/SymbolTable.c

${OBJECTDIR}/src/expressions.o: src/expressions.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/expressions.o src/expressions.c
...
${OBJECTDIR}/src/manage.o: src/manage.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/manage.o src/manage.c

${OBJECTDIR}/src/offsets.o: src/offsets.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/offsets.o src/offsets.c
...
${OBJECTDIR}/src/quads.o: src/quads.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/quads.o src/quads.c

${OBJECTDIR}/src/scanner.o: src/scanner.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/scanner.o src/scanner.c
